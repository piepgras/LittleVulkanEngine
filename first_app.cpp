...
namespace lve {
        ...
        void update(
            ...
            for (auto& vf : vectorField) {
                ...
                vf.transform2d.scale.x =
                    0.005f + 0.075f * glm::clamp(glm::log(glm::length(direction) + 1) / 3.f, 0.f, 1.f);
    ...
    void FirstApp::run() {
        ...
        red.transform2d.scale = glm::vec2{ .01f };
        red.transform2d.translation = { .5f, .5f };
        red.color = { 1.f, 0.f, 0.f };
        red.rigidBody2d.velocity = { -.3f, -.1f };
        ...
        blue.rigidBody2d.velocity = { .3f, .1f };
        ...
        GravityPhysicsSystem gravitySystem{ 0.65f };
        ...
        while (!lveWindow.shouldClose()) {
            ...
            if (auto commandBuffer = lveRenderer.beginFrame()) {
                // update systems
                gravitySystem.update(physicsObjects, 0.5f / 200, 2);
