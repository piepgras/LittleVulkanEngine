...
namespace lve {
    ...
    void LvePipeline::createGraphicsPipeline(
        ...
        assert(
            ...
            "no pipeline Layout provided in configInfo");
        assert(
            configInfo.renderPass != VK_NULL_HANDLE &&
            "Cannot create graphics pipeline:"
            "no renderPass provided in configInfo");
    ...
    void LvePipeline::defaultPipelineConfigInfo(
        ...
        configInfo.dynamicStateEnable = {
            VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR };
        configInfo.dynamicStateInfo.sType = {
            VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO };
        configInfo.dynamicStateInfo.pDynamicStates =
            configInfo.dynamicStateEnable.data();
        configInfo.dynamicStateInfo.dynamicStateCount =
            static_cast<uint32_t>(configInfo.dynamicStateEnable.size());
